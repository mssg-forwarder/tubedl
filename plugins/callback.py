...
from pyrogram import Client as adarsh, filters
...
@adarsh.on_callback_query(filters.regex(r'^view_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^thumb_del_conf_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^a_back_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^del_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^help_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^back_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^close_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^home_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^cancel_btn$'))
...
@adarsh.on_callback_query(filters.regex(r'^set_thumb_btn$'))
